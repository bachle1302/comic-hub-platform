...
const coinPackages: SeedCoinPackage[] = [
  {
    name: 'Goi 100 coin',
    coin: 100,
    price: 10000,
...
const systemSettings: SeedSystemSetting[] = [
  ...
  },
  {
    ...
    value: 'Nền tảng đọc truyện tranh online',
    valueType: SystemSettingValueType.STRING,
    group: 'general',
    label: 'Site description',
    description: 'Short public website description.',
    isPublic: true,
  },
  {
    key: 'general.logoUrl',
  ...
  },
  {
    ...
    value: 'Manga Platform - Đọc truyện tranh online',
    valueType: SystemSettingValueType.STRING,
    group: 'seo',
    label: 'Default SEO title',
    description: 'Default SEO title used by clients.',
    isPublic: true,
  },
  {
    ...
    description: 'Default SEO description used by clients.',
    isPublic: true,
  },
  {
...
async function main() {
  ...
  console.log('Coin packages: 100, 300+10, 500+50, 1000+150');
  console.log(`System settings: ${systemSettings.length} keys`);
